...
locals {
  tenant_id     = module.infrastructure_cloud-compliance-scanner-app.tenant_id
  client_id     = module.infrastructure_cloud-compliance-scanner-app.client_id
  client_secret = module.infrastructure_cloud-compliance-scanner-app.client_secret
}
